...
failed_meta=$(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeMetadata")
failed_data=$(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeData")
...
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeMetadata") == $failed_meta ]]; then
  echo -n " ==> Okay"
else
  echo -n " ==> NOT okay"
  exit_code=1
fi
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeData") == $[failed_data+1] ]]; then
  echo " ==> Okay"
else
  echo " ==> NOT okay"
  exit_code=1
...
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeData") == $[failed_data+3] ]]; then
  echo " ==> Okay"
else
  echo " ==> NOT okay"
  exit_code=1
...
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeMetadata") == $[failed_meta+1] ]]; then
  echo -n " ==> Okay"
else
  echo -n " ==> NOT okay"
  exit_code=1
fi
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeData") == $failed_data ]]; then
  echo -n " ==> Okay"
else
  echo -n " ==> NOT okay"
  exit_code=1
fi
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeParity") == $failed_parity ]]; then
  echo " ==> Okay"
else
  echo " ==> NOT okay"
  exit_code=1
...
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeParity") == $[failed_parity+1] ]]; then
  echo " ==> Okay"
else
  echo " ==> NOT okay"
  exit_code=1
...
if [[ $(echo $output | jq -r ".stats.numberOfBlocksFailedToDecodeData") == $[failed_data+2] ]]; then
  echo -n " ==> Okay"
else
  echo -n " ==> NOT okay"
  exit_code=1
