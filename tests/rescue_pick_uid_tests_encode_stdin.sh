...
output=$(cat dummy | \
           kcov_rsbx encode --json --uid $uid1 -f - rescue_picky_uid1.sbx)
...
output=$(cat dummy | \
           kcov_rsbx encode --json --uid $uid2 -f - rescue_picky_uid2.sbx)
...
output=$(cat dummy | \
           kcov_rsbx encode --json --uid $uid3 -f - rescue_picky_uid3.sbx)
